...
import { createUser, googleProvider, handleSignIn, signInUserWithEmailAndPassword, gitProvider } from './loginManager';
    ...
    return (
        <div className="login">
            <div className='login-section'>
                ...
                {user.success && <p style={{ color: 'green' }}>Created {newUser ? 'created' : 'logged in'} ok!</p>}
               
                <button onClick={() => signIn(googleProvider)}>signIn google</button>
                <br/>
                <button onClick={() => signIn(gitProvider)}>signIn github</button>
            </div>
        </div>
    );
};
